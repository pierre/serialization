...
public class ThriftToThriftEnvelopeEvent
{
     ...
     */
    public static <T extends Serializable> Event extractEvent(String eventName, T thriftObject)
    {
     ...
     * @return ThriftEnvelopeEvent which wraps all thrift fields as ThriftFields
     */
    public static <T extends Serializable> Event extractEvent(String eventName, DateTime eventDateTime, T thriftObject)
    {
        List<ThriftField> thriftFieldList = new ArrayList<ThriftField>();

        Field[] fields = thriftObject.getClass().getFields();
        for (int i = 0; i < fields.length; i++) {
            thriftFieldList.add(ThriftField.createThriftField(fields[i].getName(), (short) i));
        }
